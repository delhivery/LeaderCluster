...
final class DistanceMeasureFactory {
	...
	/**
	 * Converts aerial distance to an approximate road distance
	 *
	 * @param distance aerial distance
	 * @return aerial distance multiplied by a factor
	 */
	static double aerialToRoad(double distance) {
		if (distance <= 2000)
			distance *= 1.9346;
